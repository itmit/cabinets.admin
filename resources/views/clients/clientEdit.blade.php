        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="POST" action="/clients/{{ $id }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-12 col-sm-10">
                        <input id="password" type="password" class="form-control" name="password" value="{{ old('password') }}" maxlength="191">
                ...
                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-12 col-sm-10">
                        <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" value="" maxlength="191">
